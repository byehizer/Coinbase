...
paymentRouter.post("/", uploadSingleImage("receipts", "receipt") ,PaymentController.create);
paymentRouter.put("/:id_payment", uploadSingleImage("receipts", "receipt") ,PaymentController.update); 
