        ...
        <footer className="bg-gray-900 text-white text-lg ">
            <div className="container px-5 py-10 mx-auto flex items-center sm:flex-row flex-col">
                <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
                    ...
                    <span className="ml-3 text-2xl">Coinbase</span>
                </a>
                <p className="text-sm text-gray-300 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-500 sm:py-2 sm:mt-0 mt-4">
                    © 2025 Coinbase —
                    <span className="text-gray-400 ml-1">@Ehizer</span>
                </p>
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    ...
                    <a className="ml-6 text-gray-400 hover:text-white">
                        <svg fill="currentColor" className="w -10 h-10" viewBox="0 0 24 24">
