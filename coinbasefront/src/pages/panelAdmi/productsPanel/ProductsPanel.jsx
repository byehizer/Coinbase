...
import { Link, useNavigate } from "react-router-dom"; // Cambiar useHistory a useNavigate
...
export function ProductsPanel() {
    ...
    const navigate = useNavigate();  // Cambiar history a navigate
    ...
    const redirectToAddProduct = () => {
        navigate("/admin/products/add");  // Redirigir a la página de agregar producto
    };
